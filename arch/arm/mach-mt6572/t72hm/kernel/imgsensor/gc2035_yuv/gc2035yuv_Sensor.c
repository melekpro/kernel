...
static void GC2035_Sensor_Init(void)
{
	...
	//========================measure window  
	GC2035_write_cmos_sensor(0xfe , 0x00);
	GC2035_write_cmos_sensor(0xec , 0x06);//04 2012.10.26
	GC2035_write_cmos_sensor(0xed , 0x06);//04 2012.10.26
	GC2035_write_cmos_sensor(0xee , 0x62);//60 2012.10.26
	GC2035_write_cmos_sensor(0xef , 0x92);//90 2012.10.26
	...
	GC2035_write_cmos_sensor(0x17 , 0x14); //[0]mirror [1]flip  0x17 20131213
	...
	GC2035_write_cmos_sensor(0x24 , 0x17); //pad drive
	...
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0xa4 , 0x00);//asde_offset_slope 移动
	...
	GC2035_write_cmos_sensor(0xab , 0x31); //[0]b_dn_effect_dark_inc_or_dec
	GC2035_write_cmos_sensor(0xa9 , 0x6f); //[7:4] ASDE_DN_b_slope_high
	...
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x83 , 0x00);//[6]green_bks_auto [5]gobal_green_bks
	GC2035_write_cmos_sensor(0x84 , 0x45);//RB offset
	///=================YCP
	GC2035_write_cmos_sensor(0xd1 , 0x38);//saturation_cb
	GC2035_write_cmos_sensor(0xd2 , 0x38);//saturation_Cr
	GC2035_write_cmos_sensor(0xd3 , 0x40);//contrast 2012.10.26增加
	GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center 2012.10.26增加
	GC2035_write_cmos_sensor(0xd5 , 0x00);//luma_offset 2012.10.26增加
	...
	//GC2035_write_cmos_sensor(0x44 , 0x00);//[7]enable 2012.10.26
