...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x24, 0x03);
    ...
    GC0329_write_cmos_sensor(0x24, 0x03);//---add for Noah
	////////////////////ABS////////////////////
	...
	GC0329_write_cmos_sensor(0x44, 0xa2);//0xa0
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0329_write_cmos_sensor(0x2d, 0x05);   //exp level 1  12.50fps
			GC0329_write_cmos_sensor(0x2e, 0x40); 
			...
			GC0329_write_cmos_sensor(0x32, 0x20); 
			GC0329_SET_PAGE0;
			break;
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0329_write_cmos_sensor(0x2d, 0x05);   //exp level 0  12.00fps
			GC0329_write_cmos_sensor(0x2e, 0x2e); 
			GC0329_write_cmos_sensor(0x2f, 0x05);   //exp level 0  10.00fps
			GC0329_write_cmos_sensor(0x30, 0x2e); 
			GC0329_write_cmos_sensor(0x31, 0x06);   //exp level 0  7.05fps
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			...
			GC0329_write_cmos_sensor(0xfe, 0x01);
			GC0329_write_cmos_sensor(0x13, 0x60);//value_Y
			GC0329_write_cmos_sensor(0xfe, 0x00);
		break;
