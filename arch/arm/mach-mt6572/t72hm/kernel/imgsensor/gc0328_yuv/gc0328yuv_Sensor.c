...
void GC0328_Sensor_Init(void)
{
	...
	GC0328_write_cmos_sensor(0xfc , 0x16);
	GC0328_write_cmos_sensor(0xfc , 0x16);
	GC0328_write_cmos_sensor(0xf1 , 0x00);
	GC0328_write_cmos_sensor(0xf2 , 0x00);
	GC0328_write_cmos_sensor(0xfe , 0x00);
	...
	GC0328_write_cmos_sensor(0x77 , 0x5a);
	GC0328_write_cmos_sensor(0x78 , 0x40);
	GC0328_write_cmos_sensor(0x79 , 0x56);
	...
	/////////////banding/////////////
	GC0328_write_cmos_sensor(0x05 , 0x02);//hb
	GC0328_write_cmos_sensor(0x06 , 0x2c);//
	GC0328_write_cmos_sensor(0x07 , 0x00);//vb
	...
	GC0328_write_cmos_sensor(0x2f , 0x04);//exp level 2  10.00fps
	GC0328_write_cmos_sensor(0x30 , 0xe0);//             
	...
	GC0328_write_cmos_sensor(0x4f , 0x00);
	GC0328_write_cmos_sensor(0x4f , 0x00); 
	GC0328_write_cmos_sensor(0x4d , 0x30);
	...
	GC0328_write_cmos_sensor(0x4e , 0x04);
	GC0328_write_cmos_sensor(0x4e , 0x04);
	GC0328_write_cmos_sensor(0x4d , 0x40);
	GC0328_write_cmos_sensor(0x4e , 0x04);	
	GC0328_write_cmos_sensor(0x4e , 0x04); 
	GC0328_write_cmos_sensor(0x4e , 0x04);	
	GC0328_write_cmos_sensor(0x4e , 0x04);
	...
	GC0328_write_cmos_sensor(0x4e , 0x04);
	GC0328_write_cmos_sensor(0x4e , 0x04);
	GC0328_write_cmos_sensor(0x4d , 0x50);
	GC0328_write_cmos_sensor(0x4e , 0x04);	
	GC0328_write_cmos_sensor(0x4e , 0x04); 
	GC0328_write_cmos_sensor(0x4e , 0x04);	
	GC0328_write_cmos_sensor(0x4e , 0x04);
	...
	GC0328_write_cmos_sensor(0x4e , 0x04);
	GC0328_write_cmos_sensor(0x4e , 0x04);
	GC0328_write_cmos_sensor(0x4d , 0x60);
	GC0328_write_cmos_sensor(0x4e , 0x04);	
	GC0328_write_cmos_sensor(0x4e , 0x04); 
	GC0328_write_cmos_sensor(0x4e , 0x04);	
	GC0328_write_cmos_sensor(0x4e , 0x04);
	...
	GC0328_write_cmos_sensor(0x4e , 0x04);
	GC0328_write_cmos_sensor(0x4e , 0x04);
	GC0328_write_cmos_sensor(0x4d , 0x70);
	GC0328_write_cmos_sensor(0x4e , 0x04);	
	GC0328_write_cmos_sensor(0x4e , 0x04); 
	GC0328_write_cmos_sensor(0x4e , 0x04);	
	GC0328_write_cmos_sensor(0x4e , 0x04);
	...
	//////////// BLK//////////////////////
	GC0328_write_cmos_sensor(0xfe , 0x00); 
	GC0328_write_cmos_sensor(0x27 , 0xb7);
	...
	GC0328_write_cmos_sensor(0x3b , 0x00); 
	GC0328_write_cmos_sensor(0x3c , 0x00);
	GC0328_write_cmos_sensor(0x3d , 0x00);
	GC0328_write_cmos_sensor(0x3e , 0x00);
	...
	GC0328_write_cmos_sensor(0x42 , 0xfb);
	GC0328_write_cmos_sensor(0x44 , 0x02); //yuv
	...
	////////////YCP///////////
	GC0328_write_cmos_sensor(0xd1 , 0x30);// 0x30 for front//0x24 for back
	GC0328_write_cmos_sensor(0xd2 , 0x30);// 0x30 for front//0x24 for back
	GC0328_write_cmos_sensor(0xd3 , 0x40);
	GC0328_write_cmos_sensor(0xdd , 0xd3);
	...
	GC0328_write_cmos_sensor(0xc2 , 0x48);
	GC0328_write_cmos_sensor(0xc3 , 0x5a);
	GC0328_write_cmos_sensor(0xc4 , 0x6e);
	GC0328_write_cmos_sensor(0xc5 , 0x80);
	GC0328_write_cmos_sensor(0xc6 , 0x9c);
	GC0328_write_cmos_sensor(0xc7 , 0xb4);
	GC0328_write_cmos_sensor(0xc8 , 0xc7);
	GC0328_write_cmos_sensor(0xc9 , 0xd7);
	GC0328_write_cmos_sensor(0xca , 0xe3);
	GC0328_write_cmos_sensor(0xcb , 0xed);
	GC0328_write_cmos_sensor(0xcc , 0xf2);
	GC0328_write_cmos_sensor(0xcd , 0xf8);
	GC0328_write_cmos_sensor(0xce , 0xfd);
	GC0328_write_cmos_sensor(0xcf , 0xff);
	...
	GC0328_write_cmos_sensor(0xfe , 0x00);
	GC0328_write_cmos_sensor(0x97 , 0x30);
	GC0328_write_cmos_sensor(0x98 , 0x00);
	GC0328_write_cmos_sensor(0x9b , 0x60);
	GC0328_write_cmos_sensor(0x9c , 0x60);
	GC0328_write_cmos_sensor(0xa4 , 0x50);
	GC0328_write_cmos_sensor(0xa8 , 0x80);
	GC0328_write_cmos_sensor(0xaa , 0x40);
	GC0328_write_cmos_sensor(0xa2 , 0x23);
	GC0328_write_cmos_sensor(0xad , 0x28);
	
	//////////////abs///////////
	GC0328_write_cmos_sensor(0xfe , 0x01);
	GC0328_write_cmos_sensor(0x9c , 0x00); 
	GC0328_write_cmos_sensor(0x9e , 0xc0); 
	GC0328_write_cmos_sensor(0x9f , 0x40);	
	...
	GC0328_write_cmos_sensor(0x11 , 0x21);
	GC0328_write_cmos_sensor(0x12 , 0x11);
	GC0328_write_cmos_sensor(0x13 , 0x70);//80
	GC0328_write_cmos_sensor(0x15 , 0xfc);
	GC0328_write_cmos_sensor(0x18 , 0x02);
	GC0328_write_cmos_sensor(0x21 , 0xf0);
	...
	GC0328_write_cmos_sensor(0x3d , 0x80);
	GC0328_write_cmos_sensor(0x3e , 0x40);

	////////////////AWB///////////
	GC0328_write_cmos_sensor(0xfe , 0x01);
	GC0328_write_cmos_sensor(0x51 , 0x88);
	...
	GC0328_write_cmos_sensor(0x56 , 0x02);
	GC0328_write_cmos_sensor(0x58 , 0x00);
	GC0328_write_cmos_sensor(0x5b , 0x02);
	GC0328_write_cmos_sensor(0x5e , 0xa4);
	GC0328_write_cmos_sensor(0x5f , 0x8a);
	GC0328_write_cmos_sensor(0x61 , 0xdc);
	GC0328_write_cmos_sensor(0x62 , 0xdc);
	GC0328_write_cmos_sensor(0x70 , 0xfc);
	GC0328_write_cmos_sensor(0x71 , 0x10);
	GC0328_write_cmos_sensor(0x72 , 0x30);
	GC0328_write_cmos_sensor(0x73 , 0x0b);
	GC0328_write_cmos_sensor(0x74 , 0x0b);
	GC0328_write_cmos_sensor(0x75 , 0x01);
	GC0328_write_cmos_sensor(0x76 , 0x00);
	GC0328_write_cmos_sensor(0x77 , 0x40);
	GC0328_write_cmos_sensor(0x78 , 0x70);
	...
	GC0328_write_cmos_sensor(0x82 , 0x98);
	GC0328_write_cmos_sensor(0x83 , 0x60);
	GC0328_write_cmos_sensor(0x84 , 0x58);
	GC0328_write_cmos_sensor(0x85 , 0x50);
	GC0328_write_cmos_sensor(0xfe , 0x00);	
	...
	///////////////CCT ///////////
	/*
	GC0328_write_cmos_sensor(0xb1 , 0x12);
	GC0328_write_cmos_sensor(0xb2 , 0xf5);
	GC0328_write_cmos_sensor(0xb3 , 0xfe);
	GC0328_write_cmos_sensor(0xb4 , 0xe0);
	GC0328_write_cmos_sensor(0xb5 , 0x15);
	GC0328_write_cmos_sensor(0xb6 , 0xc8);
	*/
	   /////skin CC for front //////
	...
	GC0328_write_cmos_sensor(0x4e , 0x02);
	GC0328_write_cmos_sensor(0x4d , 0x44);
	GC0328_write_cmos_sensor(0x4e , 0x04);
	GC0328_write_cmos_sensor(0x4e , 0x04);
	GC0328_write_cmos_sensor(0x4e , 0x04);
	...
	GC0328_write_cmos_sensor(0x4e , 0x04);
	GC0328_write_cmos_sensor(0x4e , 0x04);
	GC0328_write_cmos_sensor(0x4d , 0x65);
	GC0328_write_cmos_sensor(0x4e , 0x04);
	GC0328_write_cmos_sensor(0x4d , 0x73);
	GC0328_write_cmos_sensor(0x4e , 0x20);
	GC0328_write_cmos_sensor(0x4d , 0x83);
	GC0328_write_cmos_sensor(0x4e , 0x20);
	GC0328_write_cmos_sensor(0x4f , 0x01); 
	GC0328_write_cmos_sensor(0x50 , 0x88); 
	/////////output//////// 
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC0328_write_cmos_sensor(0xd5, 0xf0);//00
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x70);//80
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
...
// set test pattern 
static UINT32 GC0328SetTestPatternMode(kal_bool bEnable)
{	
	SENSORDB("[GC0328SetTestPatternMode]bEnable=%d\n",bEnable);	

	if(bEnable)	
    {   
		GC0328_write_cmos_sensor(0xfe, 0x0);
        GC0328_write_cmos_sensor(0x40, 0x8);
        GC0328_write_cmos_sensor(0x41, 0x0);
        GC0328_write_cmos_sensor(0x42, 0x0);
        GC0328_write_cmos_sensor(0x4f, 0x0);
        GC0328_write_cmos_sensor(0x18, 0x6);
        GC0328_write_cmos_sensor(0xfe, 0x1);
        GC0328_write_cmos_sensor(0x9e, 0xc0);
        GC0328_write_cmos_sensor(0x9f, 0x40);
        GC0328_write_cmos_sensor(0xfe, 0x0);
        GC0328_write_cmos_sensor(0x77, 0x40);
        GC0328_write_cmos_sensor(0x78, 0x40);
        GC0328_write_cmos_sensor(0x79, 0x40);
        GC0328_write_cmos_sensor(0xd0, 0x40);
        GC0328_write_cmos_sensor(0xdd, 0x0);
        GC0328_write_cmos_sensor(0x71, 0x40);
        GC0328_write_cmos_sensor(0x72, 0x40);
        GC0328_write_cmos_sensor(0x3,  0x0);
        GC0328_write_cmos_sensor(0x4,  0x0);
        GC0328_write_cmos_sensor(0x4c, 0x1);
    }
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    case SENSOR_FEATURE_SET_TEST_PATTERN:            			
		GC0328SetTestPatternMode((BOOL)*pFeatureData16);            			
		break;
        
    case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE:
        *pFeatureData32 = GC0328_TEST_PATTERN_CHECKSUM;
        *pFeatureParaLen=4;
        break;
