 ...
 *
 ******************************************************************************/
FTABLE_DEFINITION(SENSOR_DRVNAME_GC0312_YUV)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
		"256x144",  "320x192",  "320x240",  "336x224", "512x288", "624x416", "640x352", "640x384",  "640x480",
            )
        ), 
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("640x480"), 
            ITEM_AS_VALUES_(
                "176x144",  "256x144",  "320x192",  "320x240",  "336x224",  "352x288",  "480x320",  "480x368", 
                "512x288",  "640x352",  "640x384",  "624x416",  "640x480",
            )
        ), 
    )
#endif
