...
FTABLE_SCENE_INDEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
        #ifdef EK_CAM_INTERPOLATION
            ITEM_AS_DEFAULT_("640x480"), 
            ITEM_AS_VALUES_(
                "336x224",  "320x240",  "624x416",  "640x480",		
                //"736x416",  "720x432",  "1024x768",  "1280x720",  "1280x768",  "1280x960", 	//Elink_yg@20140224
                //"1600x1200",   
            )
        #else
        	ITEM_AS_DEFAULT_("640x480"), 
            ITEM_AS_VALUES_(
                "336x224",  "320x240",  "624x416",  "640x480",		
                //"736x416",		"720x432",		//Elink_yg@20140224
            )
        #endif
        ), 
    )
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("640x480"), 
            ITEM_AS_VALUES_(
                "176x144",  "320x240",  "336x224",  "352x288",  "480x320",  "480x368", 
                "624x416",  "640x480",  "720x480",  "800x480",  "800x600",  "864x480", 
                "960x540",  "1280x720",     
            )
        ), 
    )
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "720x480",  // this is for cts 480p(720x480, not 640x480)
